...
export class Omni {
  constructor(scene, x, z, engineName, powerupName, visible) {
    ...
    this.meshes = {
      body: BABYLON.MeshBuilder.CreateCylinder(
        null,
        { diameter: 23, height: 10 },
        scene
      ),
    };
  ...
  attachBodyParts() {
    ...
    body.physicsImpostor = new BABYLON.PhysicsImpostor(
      ...
      { mass: this.attr.bodyMass, friction: 0.01, restitution: 0 },
      this.scene
    );
  ...
  userInput(keys) {
    ...
    if (
      this.attr.offroad &&
      this.attr.powerupName != "4 Wheel Drive" &&
    ...
    this.meshes.body.physicsImpostor.applyImpulse(
      impulseVector.scale(this.attr.bodyMass * sbMultiplier),
      this.meshes.body.getAbsolutePosition()
    );
  }
}
...
export class Tank {
  constructor(scene, x, z, engineName, powerupName, visible) {
    ...
    this.meshes = {
      body: BABYLON.MeshBuilder.CreateBox(
        null,
        { width: 22, depth: 20, height: 6 },
        scene
      ),
      wheelL1: BABYLON.MeshBuilder.CreateCylinder(
        null,
        { diameter: this.attr.wheelDiam, height: this.attr.wheelHeight },
        scene
      ),
      wheelL2: BABYLON.MeshBuilder.CreateCylinder(
        null,
        { diameter: this.attr.wheelDiam, height: this.attr.wheelHeight },
        scene
      ),
      wheelL3: BABYLON.MeshBuilder.CreateCylinder(
        null,
        { diameter: this.attr.wheelDiam, height: this.attr.wheelHeight },
        scene
      ),
      wheelL4: BABYLON.MeshBuilder.CreateCylinder(
        null,
        { diameter: this.attr.wheelDiam, height: this.attr.wheelHeight },
        scene
      ),
      wheelR1: BABYLON.MeshBuilder.CreateCylinder(
        null,
        { diameter: this.attr.wheelDiam, height: this.attr.wheelHeight },
        scene
      ),
      wheelR2: BABYLON.MeshBuilder.CreateCylinder(
        null,
        { diameter: this.attr.wheelDiam, height: this.attr.wheelHeight },
        scene
      ),
      wheelR3: BABYLON.MeshBuilder.CreateCylinder(
        null,
        { diameter: this.attr.wheelDiam, height: this.attr.wheelHeight },
        scene
      ),
      wheelR4: BABYLON.MeshBuilder.CreateCylinder(
        null,
        { diameter: this.attr.wheelDiam, height: this.attr.wheelHeight },
        scene
      ),
  ...
  attachBodyParts() {
    ...
    var mesh = this.scene.getMeshByID("TankBody");
    console.log(mesh);
    body.position.y = -15;
    mesh.parent = body;
    ...
    this.meshes.body.physicsImpostor = new BABYLON.PhysicsImpostor(
      body,
      BABYLON.PhysicsImpostor.BoxImpostor,
      { mass: this.attr.bodyMass, restitution: 0, friction: 0 },
      this.scene
    );
  }
  attachWheels() {
  ...
  wheelJoint(body, wheel, x, y, z) {
    ...
    wheel.physicsImpostor = new BABYLON.PhysicsImpostor(
      ...
      {
        mass: 1,
        friction: this.attr.wheelFriction,
        restitution: this.attr.wheelRestitution,
      },
      this.scene
    );
    var newJoint = new BABYLON.MotorEnabledJoint(
  ...
  userInput(keys) {
    var multi =
      new Date().getTime() - this.attr.sbActivationTime < sbDuration
        ? sbMultiplier
        : 1;
    if (
      this.attr.offroad &&
  ...
  forwards(multi) {
    this.motors.map((x) =>
      x.setMotor(+this.attr.speed * multi, this.attr.torque * multi)
    );
  }
  backwards(multi) {
    this.motors.map((x) =>
  ...
  forwardsLeft(multi) {
    ...
    this.motors[0].setMotor(
      (this.attr.speed / 3) * multi,
      this.attr.torque * torqueMultiBackwards * multi
    );
    this.motors[1].setMotor(
      (this.attr.speed / 3) * multi,
      this.attr.torque * torqueMultiBackwards * multi
    );
    this.motors[2].setMotor(
      (this.attr.speed / 3) * multi,
      this.attr.torque * torqueMultiBackwards * multi
    );
    this.motors[3].setMotor(
      (this.attr.speed / 3) * multi,
      this.attr.torque * torqueMultiBackwards * multi
    );
    this.motors[4].setMotor(
      this.attr.speed * multi,
      this.attr.torque * torqueMultiForwards * multi
    );
    this.motors[5].setMotor(
      this.attr.speed * multi,
      this.attr.torque * torqueMultiForwards * multi
    );
    this.motors[6].setMotor(
      this.attr.speed * multi,
      this.attr.torque * torqueMultiForwards * multi
    );
    this.motors[7].setMotor(
      this.attr.speed * multi,
      this.attr.torque * torqueMultiForwards * multi
    );
  }
...
export class Train {
  constructor(scene, x, z, engineName, visible) {
    ...
    this.meshes = {
      body: BABYLON.MeshBuilder.CreateBox(
        null,
        { width: 25, depth: 15, height: 6 },
        scene
      ),
      front: BABYLON.MeshBuilder.CreateBox(
        null,
        { width: 8, depth: 15, height: 6 },
        scene
      ),
      wheelL1: BABYLON.MeshBuilder.CreateCylinder(
        null,
      ...
      arm: BABYLON.MeshBuilder.CreateBox(
        null,
        { width: 14.5, depth: 1, height: 1 },
        scene
      ),
      arm2: BABYLON.MeshBuilder.CreateBox(
        null,
        { width: 14.5, depth: 1, height: 1 },
        scene
      ),
  ...
  attachBodyParts() {
    ...
    this.meshes.body.physicsImpostor = new BABYLON.PhysicsImpostor(
      body,
      BABYLON.PhysicsImpostor.BoxImpostor,
      { mass: this.attr.bodyMass, friction: 0 },
      this.scene
    );
  }
...
export class MT {
  constructor(scene, x, z, engineName, visible) {
    ...
    this.meshes = {
      body: BABYLON.MeshBuilder.CreateBox(
        null,
        { width: 24, depth: 20, height: 6 },
        scene
      ),
      front: BABYLON.MeshBuilder.CreateBox(
        null,
        { width: 8, depth: 20, height: 6 },
        scene
      ),
      wheel1: BABYLON.MeshBuilder.CreateCylinder(
        null,
        { diameter: this.attr.wheelDiam, height: this.attr.wheelHeight },
        scene
      ),
      wheel2: BABYLON.MeshBuilder.CreateCylinder(
        null,
        { diameter: this.attr.wheelDiam, height: this.attr.wheelHeight },
        scene
      ),
  ...
  attachBodyParts() {
    ...
    this.meshes.body.physicsImpostor = new BABYLON.PhysicsImpostor(
      body,
      BABYLON.PhysicsImpostor.BoxImpostor,
      { mass: this.attr.bodyMass, friction: 0, restitution: 0 },
      this.scene
    );
  }
  ...
  attachWheels() {
    ...
    this.wheelMeshParent(
      this.scene.getMeshByName("MTRight"),
      w2,
      3.5,
      22.7,
      -9.5
  ...
  forwardsLeft(multi) {
    this.motors[0].setMotor(
      (this.attr.speed * multi) / 4,
      this.attr.torque * multi * 0.8
    );
    this.motors[1].setMotor(this.attr.speed * multi, this.attr.torque * multi);
  }
  forwardsRight(multi) {
  ...
  right(multi) {
    this.motors[0].setMotor(
      (this.attr.speed / 2) * multi,
      this.attr.torque * multi
    );
    this.motors[1].setMotor(
      (-this.attr.speed / 2) * multi,
      this.attr.torque * multi
