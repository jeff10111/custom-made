...
export class MT {
  ...
  attachBodyParts() {
    ...
    front.physicsImpostor = new BABYLON.PhysicsImpostor(
      front,
      BABYLON.PhysicsImpostor.BoxImpostor,
      { mass: 5 },
      this.scene
    ...
    b1.setParent(null);
    b1.physicsImpostor = new BABYLON.PhysicsImpostor(
      b1,
      BABYLON.PhysicsImpostor.BoxImpostor,
      { friction: 0, mass: 10 },
      this.scene
    ...
    b2.setParent(null);
    b2.physicsImpostor = new BABYLON.PhysicsImpostor(
      b2,
      BABYLON.PhysicsImpostor.BoxImpostor,
      { friction: 0, mass: 1 },
      this.scene
